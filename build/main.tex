...
A survey pursued for the purpose of \bp's creation showed that 85\% of people living in a dense city and driving frequently would like to exchange their driveway with other driveway owner as it can be seen in \autoref{partres}. When asking this question only to driveway owner, the result becomes 79\%, presented in \autoref{pratdrivewayres}. This results show that driveway owner are willing to share their driveway only to be able to park their car in other driveways.
...
\item On average, excluding weekends, during daytime : what is the proportion of the time where your car is parked in a spot that you have to pay for ? (i.e in a paid parking lot or in a chargeable spot in the street)
...
\begin{figure}[h]
\centering
\caption{Do you own a smartphone (driving frequently) (155 answers)}
\label{drivesmartres}
