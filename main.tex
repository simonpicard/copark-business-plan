...
Another way to estimate the demand is to extrapolate the user base of \textit{JustPark}. The competitor as a total of 750 000 user\citep{jpu}. The service is mainly utilised in London, a city with 8 673 713.\cite{ciafb} Thus 8,6\% of London's inhabitant are using \textit{JustPark}. So it can be said that 8,6\% of Brussels's population would use \bp. Leading this computation to a user base composed by 101 615 people.\\
...
The price of a server suitable for 50 000 users is 893.29\$ per month.\cite{awsclwa} Thus, the price to sustain 5 000 users is 89.33\$ per month.\\
...
\item Do you own a garage with a driveway
\item Do you own a smart phone
\item Do you struggle to find a parking spot ?
\item During workday, between 9am and 5pm, how many hour is car parked in non private parking ? (ie in street or in paid parking lot)
\item On a average week, how many hours is your car parked elsewhere than at your home and in a private parking ?
\end{itemize}
